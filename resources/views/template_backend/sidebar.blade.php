            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if (Auth::user()->role == 'Admin' || Auth::user()->role == 'Operator')
                    ...
                    <li class="nav-item has-treeview" id="liMasterData">
                        ...
                        <ul class="nav nav-treeview ml-4">
                            <li class="nav-item">
                                <a href="{{ route('ppdb.index') }}" class="nav-link" id="DataMapel">
                                    <p>Calon Peserta Didik</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('ppdb.siswa.diterima') }}" class="nav-link" id="DataGuru">
                                    <p>Diterima</p>
                                </a>
                            </li>
                        </ul>
                ...
                @elseif (Auth::user()->role == 'Admin' || (Auth::user()->role == 'Guru' && Auth::user()->guru(Auth::user()->id_card)))
                ...
                @elseif (Auth::user()->role == 'Admin' ||
                    (Auth::user()->role == 'Siswa' && Auth::user()->siswa(Auth::user()->no_induk)))
                    <li class="nav-item has-treeview">
                        <a href="{{ url('/') }}" class="nav-link" id="Home">
                            <i class="nav-icon fas fa-home"></i>
                            <p>Dashboard</p>
